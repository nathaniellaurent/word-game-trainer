...
public class SixWordGenerate3L extends AppCompatActivity {
    ...
    private ImageView W1L1, W1L2, W1L3, W2L1, W2L2, W2L3, W3L1, W3L2, W3L3, W4L1, W4L2, W4L3, W5L1, W5L2, W5L3, W6L1, W6L2, W6L3;
    private String W1L1s, W1L2s, W1L3s, W2L1s, W2L2s, W2L3s, W3L1s, W3L2s, W3L3s, W4L1s, W4L2s, W4L3s, W5L1s, W5L2s, W5L3s, W6L1s, W6L2s ,W6L3s;

    MainActivity mainActivity = new MainActivity();
    ThreeLetterOperations wordOps = new ThreeLetterOperations();

    static ThreeLetterOperations.GeneratedWord genWord1 = new ThreeLetterOperations.GeneratedWord();
    static ThreeLetterOperations.GeneratedWord genWord2 = new ThreeLetterOperations.GeneratedWord();
    static ThreeLetterOperations.GeneratedWord genWord3 = new ThreeLetterOperations.GeneratedWord();
    static ThreeLetterOperations.GeneratedWord genWord4 = new ThreeLetterOperations.GeneratedWord();
    static ThreeLetterOperations.GeneratedWord genWord5 = new ThreeLetterOperations.GeneratedWord();
    static ThreeLetterOperations.GeneratedWord genWord6 = new ThreeLetterOperations.GeneratedWord();
    ...
    public int operateImages(ImageView wordCheck, ImageView wordX, ImageButton currentButton, boolean buttonPressed, boolean isReal, int currentCorrectWords, Context context) {
        ...
        MainActivity mainActivity = new MainActivity();
        if(Arrays.asList(mainActivity.readFromFile("currentThreeLetterScore.txt",context).split(", ")).size() == 1){
            mainActivity.writeToFile("currentThreeLetterScore.txt",Arrays.asList(0,0).toString(),context);
        }
        if(buttonPressed && isReal){
            ...
            mainActivity.writeToFile("currentThreeLetterScore.txt",addToWrite(0,context),context);
            return 1;
            ...
            mainActivity.writeToFile("currentThreeLetterScore.txt",addToWrite(1,context),context);
            return 0;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.six_word_generate3l);
        ...
        W1L3s = String.valueOf(genWord1.currentWord.charAt(2));
        W1L3s = W1L3s.toLowerCase(Locale.ROOT);
        ...
        W2L3s = String.valueOf(genWord2.currentWord.charAt(2));
        W2L3s = W2L3s.toLowerCase(Locale.ROOT);
        ...
        W3L3s = String.valueOf(genWord3.currentWord.charAt(2));
        W3L3s = W3L3s.toLowerCase(Locale.ROOT);
        ...
        W4L3s = String.valueOf(genWord4.currentWord.charAt(2));
        W4L3s = W4L3s.toLowerCase(Locale.ROOT);
        ...
        W5L3s = String.valueOf(genWord5.currentWord.charAt(2));
        W5L3s = W5L3s.toLowerCase(Locale.ROOT);
        ...
        W6L3s = String.valueOf(genWord6.currentWord.charAt(2));
        W6L3s = W6L3s.toLowerCase(Locale.ROOT);
        ...
        context = W1L3.getContext();
        id = context.getResources().getIdentifier(W1L3s, "drawable", context.getPackageName());
        W1L3.setImageResource(id);
        ...
        context = W2L3.getContext();
        id = context.getResources().getIdentifier(W2L3s, "drawable", context.getPackageName());
        W2L3.setImageResource(id);
        ...
        context = W3L3.getContext();
        id = context.getResources().getIdentifier(W3L3s, "drawable", context.getPackageName());
        W3L3.setImageResource(id);
        ...
        context = W4L3.getContext();
        id = context.getResources().getIdentifier(W4L3s, "drawable", context.getPackageName());
        W4L3.setImageResource(id);
        ...
        context = W5L3.getContext();
        id = context.getResources().getIdentifier(W5L3s, "drawable", context.getPackageName());
        W5L3.setImageResource(id);
        ...
        context = W6L3.getContext();
        id = context.getResources().getIdentifier(W6L3s, "drawable", context.getPackageName());
        W6L3.setImageResource(id);
        ...
        nextButton.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(SixWordGenerate3L.this, SixWordGenerate3L.class);
                // Parameter for Intent.


                // Start Example1Activity.
                SixWordGenerate3L.this.startActivity(myIntent);
        ...
        homeButtonSixWordGenerate.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(SixWordGenerate3L.this, MainActivity.class);
                // Parameter for Intent.
